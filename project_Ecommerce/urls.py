...
from app_Ecommerce.views import CategoryList, CategoryDetail, ProductList, ProductDetail, CheckoutList, CheckoutDetail, ReviewList, ReviewDetail, paymentList, paymentDetail
